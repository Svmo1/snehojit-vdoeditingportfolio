...
export default function ExitScreen() {
  ...
  return (
    <div 
      id="exit-screen-overlay"
      className="fixed inset-0 z-[9999] w-full h-full bg-[#000000] flex flex-col items-center justify-center pointer-events-none"
    ...
    >
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .text-flicker { animation: flicker 4s infinite; }
        .text-blink { animation: blink 1.5s infinite; }
        .text-neon-pulse { animation: neon-pulse 2s ease-in-out infinite; }
      `}} />
      ...
      <div className="relative z-20 flex flex-col items-center justify-center space-y-12 text-center text-[#00FF00] font-pixel px-4">
        ...
        >
          <span className="relative z-10 group-hover:text-black transition-colors duration-300 text-blink group-hover:animate-none">
